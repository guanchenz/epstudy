...
# reduced data, i.e. each row from the original is split into 3 segments
...
test_raw <- read_csv("./data/exoTest.rds")  # not reduced
# test_raw <- readRDS("./data/exoTestReduced.rds")  # reduced
